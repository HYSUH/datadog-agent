...
// zipEventLogs exports all the Windows event logs.
func zipEventLogs(tempDir, hostname string) error {
...
// exportEventLog exports one event log file to the temporary location.
// destFileName might contain a path.
func exportEventLog(eventLogChannel, destFileName, tempDir, hostname string) error {
